...
int main(){
    ...
    for(i = 1; i < stop_point + 100; i++)
    {
      ...
      if((i%500)==0)
      {
        ...
        zzzzzz1 << supply_voltage_float[0] + supply_voltage_float[4] + supply_voltage_float[8] + supply_voltage_float[12] + 5;
    ...
    if(i > stop_point)
    {
      ...
      //ret = ((int * (*)(const char*)) ngSpice_Command_handle)("wrdata CR_IVR V(30020041)");
      //ret = ((int * (*)(const char*)) ngSpice_Command_handle)("wrdata CR_IVR_gnd V(300200411)");

      //ret = ((int * (*)(const char*)) ngSpice_Command_handle)("wrdata CR_VRM V(30020021)");
      //ret = ((int * (*)(const char*)) ngSpice_Command_handle)("wrdata CR_VRM_gnd V(300200211)");
