...
int main(){
    ...
    powertrace = "sortnetwork_original.txt";
    ...
    while(outputloadnum2 < 16)  //Single layer
    {
        ...
        //power gating
        supply_voltage_float[outputloadnum2] = 1;
    }
    ...
    for(int k=0;k<16;k++)
    {
        ...
        if((measure_voltage[k]>4.5))
        {
        measure_voltage[k] = 0.1 * measure_voltage[k];
        }
        int tep = static_cast<int>(measure_voltage[k]*1000);

        //cout << "SM "<< k << " Voltage: " << tep << endl;
        cout << "SM "<< k << " Voltage: " << pp << endl;
     }
     ...
     //zzzzzz1 << supply_voltage_float[0] + supply_voltage_float[4] + supply_voltage_float[8] + supply_voltage_float[12] + 0.275;
     if(measure_voltage[1] > (supply_voltage_float[0] + supply_voltage_float[4] + supply_voltage_float[8] + supply_voltage_float[12] + 0.3))
     {

       cout << "if1-1" << endl;
       cout << "measure_voltage[2]: " << measure_voltage[2] << endl;
       cout << "(supply_voltage_float[0] + supply_voltage_float[4] + supply_voltage_float[8] + supply_voltage_float[12] + 0.15): "<< (supply_voltage_float[0] + supply_voltage_float[4] + supply_voltage_float[8] + supply_voltage_float[12] + 0.5) << endl;
     zzzzzz1 << "0.1";
     }
     else
     {
     ...
     if(measure_voltage[5] > (supply_voltage_float[4] + supply_voltage_float[8] + supply_voltage_float[12] + 0.06))
     {
       cout << "if1-2" << endl;
     zzzzzz2 << "0.1";
     cout << "measure_voltage[6]: " << measure_voltage[6] << endl;
     cout << "(supply_voltage_float[4] + supply_voltage_float[8] + supply_voltage_float[12] + 0.15): "<< (supply_voltage_float[4] + supply_voltage_float[8] + supply_voltage_float[12] + 0.15) << endl;
     }
     else
     {
       cout << "else1" << endl;
     ...
     if(measure_voltage[9] > (supply_voltage_float[8] + supply_voltage_float[12] + 0.06))
     {
       cout << "if1-3" << endl;
     zzzzzz3 << "0.1";
     }
     ...
     if(measure_voltage[13] > (supply_voltage_float[12] + 0.06))
     {
       cout << "if1-4" << endl;
     zzzzzz4 << "0.1";
     }
     ...
     cout << "Supply voltage 1: " << n << ": " << alter2 << endl;
    ...
    cout << "if2" << endl;
     ...
     aaaaaa+=cccccc;
     const char* alter2 = aaaaaa.c_str();
     cout << "Supply voltage 2: " << n << ": " << alter2 << endl;
     ret = ((int * (*)(const char*)) ngSpice_Command_handle)(alter2);
     }
     }
    ...
    if(i > stop_point)
    {
      ...
      ret = ((int * (*)(const char*)) ngSpice_Command_handle)("wrdata R_test4_1 V(440011)");
      ret = ((int * (*)(const char*)) ngSpice_Command_handle)("wrdata R_test4_1_gnd V(4400111)");
      ret = ((int * (*)(const char*)) ngSpice_Command_handle)("wrdata R_test4_2 V(440021)");
      ret = ((int * (*)(const char*)) ngSpice_Command_handle)("wrdata R_test4_2_gnd V(4400211)");
      ret = ((int * (*)(const char*)) ngSpice_Command_handle)("wrdata R_test4_3 V(440031)");
      ret = ((int * (*)(const char*)) ngSpice_Command_handle)("wrdata R_test4_3_gnd V(4400311)");
      ret = ((int * (*)(const char*)) ngSpice_Command_handle)("wrdata R_test4_4 V(440041)");
      ret = ((int * (*)(const char*)) ngSpice_Command_handle)("wrdata R_test4_4_gnd V(4400411)");
