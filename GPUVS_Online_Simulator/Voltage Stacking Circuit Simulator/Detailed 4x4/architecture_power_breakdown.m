...
x1 = data1(1:1:10000,1);
x2 = data1(1:1:10000,2);
x3 = data1(1:1:10000,3);
x4 = data1(1:1:10000,4);
x5 = data1(1:1:10000,5);
x6 = data1(1:1:10000,6);
x7 = data1(1:1:10000,7);
x8 = data1(1:1:10000,8);
x9 = data1(1:1:10000,9);
x10 = data1(1:1:10000,10);
x11 = data1(1:1:10000,11);
x12 = data1(1:1:10000,12);
x13 = data1(1:1:10000,13);
x14 = data1(1:1:10000,14);
x15 = data1(1:1:10000,15);
...
x21 = data2(1:1:10000,1);
x22 = data2(1:1:10000,2);
x23 = data2(1:1:10000,3);
x24 = data2(1:1:10000,4);
x25 = data2(1:1:10000,5);
x26 = data2(1:1:10000,6);
x27 = data2(1:1:10000,7);
x28 = data2(1:1:10000,8);
x29 = data2(1:1:10000,9);
x210 = data2(1:1:10000,10);
x211 = data2(1:1:10000,11);
x212 = data2(1:1:10000,12);
x213 = data2(1:1:10000,13);
x214 = data2(1:1:10000,14);
x215 = data2(1:1:10000,15);
...
legend('No Architecture Assistance','Synchronized SM Start')
...
xl = xlabel('Residual unbalance current(A)');